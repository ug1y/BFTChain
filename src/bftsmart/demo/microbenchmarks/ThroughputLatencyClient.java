...
public class ThroughputLatencyClient {
    ...
    static class Client extends Thread {
		...
		if (interval > 0) {
            ...
            if(id == initId) {
                System.out.println(this.id + " // Average time for " + numberOfOps / 2 + " executions (-10%) = " + st.getAverage(true) / 1000000 + " ms ");
                System.out.println(this.id + " // Standard desviation for " + numberOfOps / 2 + " executions (-10%) = " + st.getDP(true) / 1000000 + " ms ");
