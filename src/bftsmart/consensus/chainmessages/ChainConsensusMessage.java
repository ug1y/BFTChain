...
public class ChainConsensusMessage extends SystemMessage {

    protected int msgType; // chain consensus message type, including proposal, vote and sync
    ...
    public String toString(){
        return "msgType = " + this.msgType + ", viewNumber = " + this.viewNumber + "consId = " + this.consId +
