...
public class NewMessageFactory{
    ...
    public NewConsensusMessage createPROPOSE(byte[] data, int viewNumber, int hashValue,
                                             Object setofvotes){
        NewConsensusMessage m = new NewConsensusMessage(PROPOSE, viewNumber, from);
     ...
     */
    public NewConsensusMessage createVOTE(int viewNumber, int hashValue){
        NewConsensusMessage m = new NewConsensusMessage(VOTE, viewNumber, from);
        m.setHashValue(hashValue);
        return m;
    }
     ...
     */
    public NewConsensusMessage createSYNC(int viewNumber, Object newMessage){
        NewConsensusMessage m = new NewConsensusMessage(SYNC, viewNumber, from);
